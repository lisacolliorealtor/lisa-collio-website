...
**Version:** v1.4 · Updated 30 July 2026 · Governed by Master Plan v2.15 and all documents in its hierarchy. Update this file's version number whenever the checklist itself changes, following the locked file-naming convention (version first, description, "Lisa Collio" last).
